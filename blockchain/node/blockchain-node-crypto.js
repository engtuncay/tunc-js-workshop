...
// Blockchain sınıfı - Tüm blokları yöneten ana sınıf (Node.js Crypto versiyonu)
export class Blockchain {
    ...
    constructor() {
        ...
        this.difficulty = 2; // Mining zorluğu (Node.js crypto ile biraz artırıldı)
    ...
    createGenesisBlock() {
        ...
        console.log("✨ Genesis Block oluşturuldu - UTXO sistemi başlatıldı (Node.js Crypto)");
        return genesisBlock;
    }
    ...
    // İşlem hash'i oluştur (Node.js crypto kullanarak)
    createTransactionHash(transaction) {
        ...
        try {
            return crypto.createHash('sha256').update(transactionString).digest('hex').substring(0, 16);
        } catch (error) {
            // Fallback hash
            let hash = 0;
    ...
    // Başlangıç bakiyelerini oluştur (Node.js için yardımcı fonksiyon)
    initializeBalances() {
        ...
        console.log('✅ Başlangıç bakiyeleri oluşturuldu!');
    ...
    isChainValid() {
        ...
        console.log('✅ Blockchain ve UTXO set geçerli! (Node.js Crypto Edition)');
        return true;
    }
